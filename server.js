...
import slideRoutes from './server/routes/slides.js';
...
// Middleware
app.use(cors({
  origin: process.env.FRONTEND_URL || 'https://dagalma-hbg0v6uzy-pape-ndiogou-niangs-projects.vercel.app',
  credentials: true
}));
...
app.listen(PORT, () => {
  ...
  console.log(`💳 Paytech API: ${process.env.PAYTECH_API_URL}`);
});
